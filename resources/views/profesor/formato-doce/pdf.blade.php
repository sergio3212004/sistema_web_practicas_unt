...
<div class="info-section">
    ...
    <div class="info-row">
        ...
        <span class="info-value">{{ $formato->ciclo ?? 'N/A' }}</span>
    </div>
...
<table>
    ...
    <tr>
        ...
        <th class="col-contacto" rowspan="2">Datos de contacto de responsable de la Sede de Práctica Pre Profesional (correo/teléfono)</th>
