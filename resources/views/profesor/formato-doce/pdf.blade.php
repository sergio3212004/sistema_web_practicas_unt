...
<div class="info-section">
    <div class="info-row">
        ...
        <span class="info-value">{{ $formato->created_at->format('d/m/Y') }}</span>
    </div>
    ...
    <div class="info-row">
        ...
        <span class="info-value">{{ $formato->aula->ciclo ?? 'N/A' }}</span>
    </div>

    <div class="info-row">
        <span class="info-label">SEMESTRE:</span>
        <span class="info-value">{{ $formato->aula->semestre->nombre ?? 'N/A' }}</span>
    </div>

    <div class="info-row">
        <span class="info-label">NIVEL DE LA PRÁCTICA PRE PROFESIONAL (INICIAL/INTERMEDIO/AVANZADO):</span>
        <span class="info-value" style="text-transform: uppercase;">{{ $formato->nivel }}</span>
    </div>
</div>
...
<table>
    ...
    <tr>
        ...
        <th class="col-contacto">Datos de contacto de responsable de la Sede de Práctica Pre Profesional (correo/teléfono)</th>
    ...
    @if($formato->formatosDoceAlumnos->count() < 5)
        @for($i = $formato->formatosDoceAlumnos->count(); $i < 5; $i++)
            <tr>
...
<div class="firma-section">
    @if($formato->firma_coordinador)
        <img src="{{ public_path('storage/' . $formato->firma_coordinador) }}"
             alt="Firma"
             class="firma-image">
    @endif
