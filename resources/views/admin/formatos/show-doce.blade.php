            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        <a href="{{ route('admin.formatos.index', $formatoDoce->aula->id) }}"
                    ...
                    <div class="flex gap-3">
                        <a href="{{ route('admin.formatos.doce.pdf', $formatoDoce->id) }}"
                           target="_blank"
            ...
            <div class="bg-gradient-to-r from-blue-700 to-blue-900 rounded-lg shadow-sm p-6 mb-6 text-white">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <p class="font-semibold text-lg">{{ $formatoDoce->created_at->format('d/m/Y') }}</p>
                    </div>
                    <div>
                        <p class="text-blue-100 text-sm">Semestre</p>
                        <p class="font-semibold text-lg">{{ $formatoDoce->aula->semestre->nombre ?? 'N/A' }}</p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <p class="font-semibold text-lg">{{ $formatoDoce->aula->numero ?? 'N/A' }}</p>
                    </div>
                    <div>
                        <p class="text-blue-100 text-sm">Nivel de Práctica</p>
                        <p class="font-semibold text-lg uppercase">{{ $formatoDoce->nivel }}</p>
                    </div>
                    <div>
                        <p class="text-blue-100 text-sm">Total Estudiantes</p>
                        <p class="font-semibold text-lg">{{ $formatoDoce->formatosDoceAlumnos->count() }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div class="border-2 border-gray-300 rounded-lg p-4 bg-gray-50 inline-block">
                    @if($formatoDoce->firma_coordinador)
                        <img src="{{ asset('storage/' . $formatoDoce->firma_coordinador) }}"
