        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden border-2 border-gray-200">
                ...
                <div class="p-8">
                    ...
                    <form action="{{ route('profesor.monitoreos-practicas.store') }}" method="POST" id="formMonitoreo">
                        @csrf
                                            ...
                                            <tr class="hover:bg-blue-50 transition-colors">
                                                ...
                                                <td class="border-2 border-blue-200 px-4 py-4">
                                                    <textarea name="actividades[{{ $index }}][observacion]"
                                                              ...
                                                              class="w-full px-3 py-2 border-2 border-blue-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm resize-none"></textarea>
                                                </td>
                                                <td class="border-2 border-blue-200 px-4 py-4">
                                                    <div class="flex flex-col items-center">
                                                        ...
                                                        <input type="hidden" name="actividades[{{ $index }}][firma_supervisor]" id="firmaSupervisor_{{ $index }}" required>
                                                        <button type="button"
                                    ...
                                    <div class="flex items-start">
                                        ...
                                        <div class="ml-3">
                                            <p class="text-sm text-blue-800">
                                                <strong>Instrucciones:</strong> Por favor, firme en cada celda de la última columna para validar el monitoreo de cada actividad.
                                                La firma del practicante será solicitada en otro formulario.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="flex items-start">
                    ...
                    <div class="ml-4">
                        ...
                        <ul class="text-sm text-blue-700 list-disc list-inside space-y-1">
                            ...
                            <li>El practicante completará su firma posteriormente en su propia vista</li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    @push('scripts')
        <script>
            ...
            document.getElementById('formMonitoreo').addEventListener('submit', function(e) {
                ...
                if (!todasFirmadas) {
                    e.preventDefault();
                    alert('Por favor, complete todas las firmas:\n\n' + mensajesError.join('\n'));
                    return false;
                }
